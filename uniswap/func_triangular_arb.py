...
def calc_triangular_arb_surface_rate(t_pair, min_rate):
    ...
    for direction in direction_list:
        ...
        # Format Description
        trade_description_1 = f"Inicia con {swap_1} con monto de {starting_amount}. intercambia a {swap_1_rate} por {swap_2} adquiere {acquired_coin_t1}."
        trade_description_2 = f"intercambia {acquired_coin_t1} de {swap_2} a {swap_2_rate} por {swap_3} adquiere {acquired_coin_t2}."
        trade_description_3 = f"intercambia {acquired_coin_t2} de {swap_3} a {swap_3_rate} por {swap_1} adquiere {acquired_coin_t3}."

        trade_result = acquired_coin_t3-starting_amount
